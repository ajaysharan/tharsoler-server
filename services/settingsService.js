import { Settings, DEFAULT_OTP_HTML, DEFAULT_OTP_SUBJECT, DEFAULT_THANKYOU_HTML, DEFAULT_THANKYOU_SUBJECT, DEFAULT_INQUIRY_HTML, DEFAULT_INQUIRY_SUBJECT } from '../models/Settings.js';
...
export async function getSettings() {
  ...
  if (!doc) {
    doc = await Settings.create({ _id: 'main' });
    return doc;
  }
