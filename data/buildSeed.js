...
export function buildSeed() {
  ...
  const inquiries = [
    ['Hari Ram', '9829011001', 'Badi Khatu', 'Residential', 2800, '3 kW', 'new', 'Website', 'vikram', 0],
    ['Suman Devi', '9414112233', 'Nagaur', 'Residential', 4200, '5 kW', 'contacted', 'WhatsApp', 'meena', 1],
    ['Ganesh Traders', '9829123456', 'Kuchaman', 'Commercial', 18000, '10 kW+', 'quoted', 'Call', 'meena', 2],
    ['Ramesh Jakhar', '9982110099', 'Didwana', 'Farm', 0, 'Not sure — please suggest', 'qualified', 'Walk-in', 'vikram', 2],
    ['Khatu Public School', '9414007788', 'Badi Khatu', 'Institutional', 32000, '10 kW+', 'won', 'Referral', 'admin', 8],
    ['Mohit Soni', '9782001122', 'Merta', 'Residential', 3500, '3 kW', 'lost', 'Website', 'pooja', 12],
    ['Ladnun Hardware', '9828445566', 'Ladnun', 'Commercial', 9500, '5 kW', 'quoted', 'WhatsApp', 'meena', 4],
    ['Bhagirath', '9414556677', 'Jayal', 'Residential', 2100, '1 kW', 'new', 'Website', 'pooja', 0],
    ['Shree Flour Mill', '9982778899', 'Nagaur', 'Industrial', 45000, '10 kW+', 'qualified', 'Call', 'admin', 5],
    ['Anita Kanwar', '9828332211', 'Parbatsar', 'Residential', 5100, '5 kW', 'contacted', 'WhatsApp', 'vikram', 1],
    ['Om Prakash', '9414221100', 'Makrana', 'Residential', 1900, '1 kW', 'new', 'Website', '', 0],
    ['Desert Agro Farm', '9782665544', 'Degana', 'Farm', 0, 'Not sure — please suggest', 'quoted', 'Referral', 'meena', 6],
    ['City Mart', '9828003344', 'Nagaur', 'Commercial', 12000, '10 kW+', 'won', 'Walk-in', 'admin', 18],
    ['Kamla Devi', '9982001123', 'Badi Khatu', 'Residential', 2600, '3 kW', 'contacted', 'Call', 'pooja', 3],
    ['New India Workshop', '9414887766', 'Kuchaman', 'Industrial', 22000, '10 kW+', 'new', 'Website', 'vikram', 1],
    ['Suresh Choudhary', '9829112234', 'Mundwa', 'Residential', 3300, '3 kW', 'qualified', 'WhatsApp', 'meena', 4],
    ['Gram Panchayat Hall', '9414009900', 'Jayal', 'Institutional', 8000, '5 kW', 'quoted', 'Referral', 'admin', 9],
    ['Priya Sharma', '9782110098', 'Nagaur', 'Residential', 4700, '5 kW', 'new', 'Website', '', 0],
    ['Thar Motors', '9828221100', 'Badi Khatu', 'Commercial', 15000, '10 kW+', 'won', 'Walk-in', 'admin', 28],
    ['Baldev Singh', '9982445566', 'Nawa', 'Farm', 0, 'Not sure — please suggest', 'lost', 'Call', 'vikram', 20],
    ['Asha Boutique', '9414332211', 'Merta', 'Commercial', 6200, '5 kW', 'contacted', 'WhatsApp', 'pooja', 2],
    ['Hanuman Temple Trust', '9828776655', 'Khatu', 'Institutional', 11000, '5 kW', 'qualified', 'Referral', 'meena', 7],
    ['Jagdish Tailor', '9782009988', 'Didwana', 'Residential', 1500, '1 kW', 'new', 'Website', 'pooja', 1],
    ['RK Petrol Pump', '9414667788', 'Nagaur', 'Commercial', 28000, '10 kW+', 'quoted', 'Call', 'admin', 11],
    ['Sunita Yadav', '9982112233', 'Parbatsar', 'Residential', 3900, '3 kW', 'contacted', 'WhatsApp', 'vikram', 0],
    ['Green Valley Farm', '9828441122', 'Degana', 'Farm', 0, 'Not sure — please suggest', 'new', 'Walk-in', '', 2],
    ['Mohan Lal', '9414110099', 'Badi Khatu', 'Residential', 2400, '3 kW', 'won', 'Website', 'meena', 35],
    ['Shakti Hardware', '9782334455', 'Ladnun', 'Commercial', 8700, '5 kW', 'lost', 'Call', 'pooja', 16],
  ].map((row, i) => {
    const [name, phone, city, propertyType, bill, capacity, status, source, assignedKey, ago] = row;
    return {
      key: `inq_${i + 1}`,
      name,
      phone,
